...
<html lang="pt-BR">
    ...
    <body>
		...
		<nav class="navbar navbar-dark fixed-top navbar-expand-md navbar-no-bg">
			<div class="container">
				<a class="navbar-brand" href="index.php">Arsystem</a>
			    ...
			    <div class="collapse navbar-collapse" id="navbarNav">
			        <ul class="navbar-nav ml-auto">
			            ...
			            <li class="nav-item">
			                <a class="nav-link scroll-link" href="#services">Sistema</a>
			            </li>
			            <li class="nav-item">
			                <a class="nav-link scroll-link" href="#about-us">Sobre</a>
			            </li>
			            <li class="nav-item">
			                <a class="nav-link scroll-link" href="#portfolio">Fotos</a>
			            </li>
			            <li class="nav-item">
			                <a class="nav-link scroll-link" href="#testimonials">Teste</a>
			            </li>
			            <li class="nav-item">
			                <a class="nav-link scroll-link" href="#blog">Noticias</a>
			            </li>
			        </ul>
			    </div>
		    </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-8 offset-md-2 text">
                        <h1 class="wow fadeInLeftBig">ARSYSTEM</h1>
                        ...
                        <div class="top-big-link wow fadeInUp">
                        	<a class="btn btn-primary btn-link-2 scroll-link" href="#services">Saiba-Mais</a>
                        </div>
                    </div>
                </div>
	            	...
	            	<div class="col-12 col-lg-7 about-us-box wow fadeInLeft">
	                    <div class="about-us-box-text">
	                    	...
	                    	<p>
	                    		...
	                    		Exerci tation ullamcorper suscipit <a href="#">teste link</a> ut aliquip ex ea commodo consequat. 
	        ...
	        <div class="container">
	            <div class="row">
	                <div class="col portfolio section-description wow fadeIn">
	                    <h2>Fotos</h2>
	                    <div class="divider-1 wow fadeInUp"><span></span></div>
	                    <p>Fotos dos Cultos e Eventos</p>
	                </div>
	            </div>
	            <div class="row">
	            ...
	            <div class="row">
	            	<div class="col section-bottom-button wow fadeInUp">
                        <a class="btn btn-primary btn-link-3" href="#">Ver Mais</a>
	            	</div>
	            </div>
	        </div>
        </div>
        ...
        <div class="blog-container section-container">
	        <div class="container">
	            ...
	            <div class="row">
	                <div class="col-md-6 blog-box wow fadeInLeft">
	                	<div class="row">
	                		...
	                		<div class="col-md-9">
	                			<h3><a href="#">gfgfgfhgffgfgf</a> <i class="fas fa-angle-right"></i></h3>
	                ...
	                <div class="col-md-6 blog-box wow fadeInLeft">
	                	<div class="row">
	                		...
	                		<div class="col-md-9">
	                			<h3><a href="#">fggfgfgfgfgfgf</a> <i class="fas fa-angle-right"></i></h3>
	            ...
	            <div class="row">
	                <div class="col-md-6 blog-box wow fadeInLeft">
	                	<div class="row">
	                		...
	                		<div class="col-md-9">
	                			<h3><a href="#">gfgfgfgfgfgfgt</a> <i class="fas fa-angle-right"></i></h3>
	                ...
	                <div class="col-md-6 blog-box wow fadeInLeft">
	                	<div class="row">
	                		...
	                		<div class="col-md-9">
	                			<h3><a href="#">gfgfgfgfgfgfgf</a> <i class="fas fa-angle-right"></i></h3>
	            ...
	            <div class="row">
	            	<div class="col section-bottom-button wow fadeInUp">
                        <a class="btn btn-primary btn-link-3" href="#">teste</a>
	            	</div>
	            </div>
	        ...
	        <div class="container">
	        	<div class="row">
                    <div class="col-md-3 footer-left">
                    	<p>&copy; ARSYSTEM-2018 <a href="index.php">AR</a>.</p>
                    </div>
                    <div class="col-md-2 footer-left">
                    	<p> Robson <a href="https://github.com/gds15">GIT</a>.</p>
                    	<p> Gustavo <a href="https://github.com/gds15">GIT</a>.</p>
                    </div>
